        ...
        <div>
            ...
            <div class="row">
                <div class="side">
                    ...
                    <h3 >
                        联系方式: <span style="font-size: small"> {{ this.$GLOBAL.userNumber }} </span>
                    </h3>
                    <div>
        ...
        created() {
            ...
            this.$axios.post(
                '/Conservator/selectPhoneNumber',
                {
                    ...
                    "name": "",
                    "password": 0,
                    "phonenumber": this.$GLOBAL.userNumber
                },
            ).then(
                async function (response) {
                    ...
                    that.returnObject = that.info.returnObject[0];
                    that.name = that.returnObject.name;
                    that.phoneNumber = that.returnObject.phonenumber;
                    that.imageurl = that.returnObject.imageurl;
                }
            )
        },
        methods: {
